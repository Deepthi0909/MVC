...
namespace MvcApplication.Models
{
    ...
    {
        public int CategoryId { get; set; } //no validations for categoryId
    ...
    public class CategoryDataAccess
    {
        ...
        const string defaultConnectionString = @"Data Source=BANAVASI\SQLDEV2016;Initial Catalog=Northwind;user id=sa; pwd=sa";
