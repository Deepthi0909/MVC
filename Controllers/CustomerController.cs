...
namespace MvcApplication.Controllers
{
    ...
    public class CustomerController : Controller
    {
        ...
        {
            var model = repository.GetAll(); // get all customers and store it to model
            return View(model: model); //passs model to view
        }
        ...
        [Authorize]
        public ActionResult Edit(string id)  //get
        {
            var model = repository.GetDetails(identity: id);
            if (model != null)
                return View(model);
        ...
        public ActionResult Edit(Customer model)
        {
            ...
            //// validate date. Create model entity
